...
#     dist = get_dist(final_embs)
    ...
    return x, within_period_x, final_embs, sims
...
#     """Calculates self-distance between embeddings"""
#   batch_size = tf.shape(embs)[0]
#   seq_len = tf.shape(embs)[1]
#   embs = tf.reshape(embs, [batch_size, seq_len, -1])

#   def _get_dist(embs):
#     """Calculates self-distance between sequence of embeddings."""
